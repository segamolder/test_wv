...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    getAllRoles: function getAllRoles() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["get"]('/api/user-role', {}).then(function (response) {
        _this.user_roles = response.data;
      });
    },
    addNewRole: function addNewRole() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["post"]('/api/user-role', data, {}).then(function (response) {
        _this2.role = '';
    ...
    getAllUsers: function getAllUsers() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["get"]('/api/user', {}).then(function (response) {
    ...
    addNewUser: function addNewUser() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0__["post"]('/api/user', data, {}).then(function (response) {
        _this4.user = '';
        _this4.selected_role = '';
...
var render = function() {
  ...
  return _c("div", { staticClass: "row" }, [
    _c("div", { staticClass: "col-md-6" }, [
      ...
      _c("div", { staticClass: "input-group mb-3" }, [
        _c("input", {
          ...
          attrs: {
            ...
            "aria-describedby": "add-user-role"
          },
        ...
        _c("div", { staticClass: "input-group-append" }, [
          _c(
            "button",
            {
              ...
              attrs: { type: "button", id: "add-user-role" },
      ...
      _c(
        "ul",
        { staticClass: "list-group wrapper-60 mt-2" },
    ...
    _c("div", { staticClass: "col-md-6" }, [
      ...
      _c("div", { staticClass: "form-group" }, [
        _c("input", {
          ...
          attrs: { type: "text", placeholder: "Add new user" },
        ...
        _c(
          "button",
          { staticClass: "btn btn-primary", on: { click: _vm.addNewUser } },
          [_vm._v("Add")]
        ),
        _vm._v(" "),
        _c(
          "ul",
          { staticClass: "list-group mt-3 wrapper-50" },
          _vm._l(_vm.users, function(user) {
            return _c("li", { staticClass: "list-group-item mb-1" }, [
              _c("p", [
                _vm._v("User: "),
                _c("i", [_vm._v(_vm._s(user.username))])
              ]),
              _vm._v(" "),
              _c("p", [
                _vm._v("User role: "),
                _c("i", [_vm._v(_vm._s(user.role.rolename))])
              ])
            ])
          }),
          0
...
Vue.component('app', __webpack_require__(/*! ../js/App.vue */ "./resources/js/App.vue")["default"]);
var app = new Vue({
  el: '.container'
});
...
__webpack_require__(/*! C:\Program Files\OSPanel\domains\test_wv\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Program Files\OSPanel\domains\test_wv\resources\sass\app.scss */"./resources/sass/app.scss");
